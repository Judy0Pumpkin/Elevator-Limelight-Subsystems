...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int kRearRightTurningEncoderPorts =   4;
  ...
  public static final class ElevatorConstant {
    ...
    public static final double kMaximunSensorVelocity = 4096;
    public static final double kElevatorEncoderDistancePerPulse = 1;
